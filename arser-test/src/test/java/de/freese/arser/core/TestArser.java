...
class TestArser {
    ...
    static void beforeAll() throws Exception {
        ...
        repositoryLocal = new FileRepository("deploy-snapshots", PATH_TEST.resolve("deploy-snapshots").toUri(), true);
        lifecycleManager.add(repositoryLocal);

        repositoryVirtual = new VirtualRepository("public", List.of(repositoryMavenCentral, repositoryGradleReleases, repositoryLocal));
    ...
    void testLocalWriteable() throws Exception {
        ...
        try (InputStream inputStream = new ByteArrayInputStream(buffer)) {
            repositoryLocal.write(resourceRequest, inputStream);
        }
    ...
    void testRemoteGradleReleases() throws Exception {
        ...
        final boolean exist = repositoryGradleReleases.exist(resourceRequest);
    ...
    void testRemoteMavenCentral() throws Exception {
        ...
        final boolean exist = repositoryMavenCentral.exist(resourceRequest);
    ...
    void testVirtual() throws Exception {
        ...
        exist1 = repositoryVirtual.exist(resourceRequest);
        assertTrue(exist1);

        resourceRequest = ResourceRequest.of(URI.create("/public/org/apache/maven/maven/3.8.4/maven-3.8.4.pom"));
        exist2 = repositoryVirtual.exist(resourceRequest);
        assertTrue(exist2);
