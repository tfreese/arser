...
class TestFileRepository {
    ...
    //
    //     final Repository repository = new FileRepository(pathTest.resolve(contentRoot).toUri(), contentRoot, false);
    //     repository.start();
    //
    ...
    //
    //     final ArserRequest resourceRequest = ArserRequest.of(URI.create("/" + contentRoot + "/" + RESOURCE));
    //
    //     try {
