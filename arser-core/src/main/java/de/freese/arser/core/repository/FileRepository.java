...
//
//     @Override
//     protected boolean doExist(final ArserRequest resourceRequest) {
...
//
//     @Override
//     protected FileResource doGetResource(final ArserRequest resourceRequest) throws Exception {
//         final Path path = toPath(resourceRequest.getResource());
//
//         if (getLogger().isDebugEnabled()) {
...
//
//     @Override
//     protected void doWrite(final ArserRequest resourceRequest, final InputStream inputStream) throws Exception {
//         if (!writeable) {
