...
public final class RepositoryBuilder {
    ...
    public static Repository buildRemote(final RemoteRepoConfig remoteRepoConfig, final LifecycleManager lifecycleManager, final RepositoryManager repositoryManager,
                                         final JreHttpClientComponent httpClientComponent) {
